...
const EditClasses = () => {
    ...
    const [departId, setDepartId] = useState(location.state.department)
    const [generations, setGenerations] = useState(null)
    const [genId, setGenId] = useState(location.state.generation)
    ...
    const [lecSubject, setLecSubject] = useState(location.state.userSubject)
    const [subjects, setSubjects] = useState(null)

    useEffect(() => {
        console.log("First")
        console.log("Lec: ", location.state.userSubject)
    ...
    console.log("Lecturer: ", lecSubject)
    ...
    const onSubmit = values => {
        ...
        baseAPI.patch(`/classes/${location.state.key}`, values)
            .then(response => {
    ...
    return (
        <Fragment>
            ...
            <Form
                ...
                initialValues={{
                    "classesName": location.state.classesName,
                    "classesCode": location.state.classesCode,
                    "shift": location.state.shift,
                }}
            >
                <HeaderPage id="edit_class" button={buttonTem()} />
